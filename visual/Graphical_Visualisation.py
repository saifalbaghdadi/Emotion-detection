...
test_model = FacialExpressionModel("./model/model.json", "./model/model_weights.h5")
...
facec = cv2.CascadeClassifier('visual\cascade\haarcascade_frontalface_default.xml')
...
def Emotion_Analysis(img):
    ...
    for (x, y, w, h) in faces:
        ...
        # I make the Prediction of Emotion present in the Image
        ...
        # based on the prediction recommend suggest
        ...
        plt.bar(EMOTIONS, data, color='red',
                width=0.4)
